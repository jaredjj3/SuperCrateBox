...
export const ELECTRIC_SHIELD_RECOVERY_TIME = 100; // millisecs

export const ENEMY_ONE_VEL = 350;
export const ENEMY_ONE_INIT_VEL = -400;
export const ENEMY_SPAWN_RATE = 4750;  // every n millisecs

export const POWERUP_SPAWN_RATE = 6000; // every n millisecs
